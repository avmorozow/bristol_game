...
export function OriginalSquirrel({home,attemptId,boosterUsed}:{home:boolean;attemptId?:string;boosterUsed?:boolean}){
 ...
 return <div className={`original-squirrel-scene ${retreat?'original-squirrel-retreat':''}`} aria-hidden="true"><div className="original-squirrel-crop"><img src="/assets/squirrel-empty.webp" alt=""/></div></div>;
}
